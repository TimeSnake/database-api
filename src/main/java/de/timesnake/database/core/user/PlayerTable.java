...
public abstract class PlayerTable extends DefinitionAndQueryTool {

  public PlayerTable(DatabaseConnector databaseConnector, String nameTable) {
  ...
  public void addPlayer(UUID uuid, String name) {
    super.addEntrySynchronized(new PrimaryKeyEntries(new Entry<>(uuid, Column.User.UUID)),
