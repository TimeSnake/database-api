...
public class InfoTable extends PlayerTable {

  public InfoTable(DatabaseConnector databaseConnector, String nameTable) {
  ...
  @Override
  public void save() {
    Column<?>[] columns = {Column.User.UUID, Column.User.NAME, Column.User.PREFIX,
        Column.User.SUFFIX,
        Column.User.NICK, Column.User.TIME_COINS, Column.User.PERM_GROUP,
        Column.User.PRIVACY_POLICY,
  ...
  public void addPlayer(UUID uuid, String name, String permGroup, String server) {
    ...
    super.setSynchronized(
        Set.of(new Entry<>(Status.User.ONLINE, Column.User.STATUS), new Entry<>(false
                ...
                Column.User.SERVER_LAST), new Entry<>(server, Column.User.SERVER_LOBBY),
            new Entry<>(false,
