...
public class DbSimpleGameInfo extends KeyedQueryTool implements
    de.timesnake.database.util.game.DbGameInfoBasis {

  public DbSimpleGameInfo(DatabaseConnector databaseConnector, String nameTable, String gameName) {
    super(databaseConnector, nameTable, true, new Entry<>(gameName, Column.Game.NAME));
  }
  ...
  public String getName() {
    return super.keyEntries.get(Game.NAME).getValue();
  }
  ...
  public de.timesnake.database.util.game.DbGameInfoBasis toLocal() {
    return new DbCachedSimpleGameInfo(this);
  }
