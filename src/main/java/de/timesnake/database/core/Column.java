...
public class Column<Value> {
  ...
  public static class Server<T> extends Column<T> {
    ...
    public static final Server<Integer> PORT = new Server<>("port", ColumnType.INTEGER.notNullable().unique());
    public static final Server<Status.Server> STATUS = new Server<>("status", ColumnType.STATUS());
    public static final Server<Integer> MAX_PLAYERS = new Server<>("max_players", ColumnType.INTEGER);
    ...
    public static final Server<String> GAME_INFO = new Server<>("info", ColumnType.VARCHAR(255));
    public static final Server<String> MAP_NAME = new Server<>("map_name", ColumnType.VARCHAR(32));
    ...
    public static final Server<Integer> TEAM_AMOUNT = new Server<>("team_amount", ColumnType.INTEGER);
    public static final Server<Integer> TEAM_MAX_PLAYERS = new Server<>("team_max_players", MAX_PLAYERS.getType());
    public static final Server<Boolean> TEAM_MERGING = new Server<>("team_merging", ColumnType.BOOLEAN);
    public static final Server<String> TWIN_SERVER = new Server<>("twin_server", NAME.getType());
    public static final Server<String> PASSWORD = new Server<>("password", ColumnType.VARCHAR(255));
  ...
  public static class User<T> extends Column<T> {
    ...
    public static final User<String> NAME = new User<>("name", ColumnType.VARCHAR(16).notNullable());
    public static final User<Status.User> STATUS = new User<>("status", ColumnType.STATUS());
    public static final User<Boolean> ANTI_CHEAT_MESSAGES = new User<>("anti_cheat_messages", ColumnType.BOOLEAN);
    ...
    public static final User<String> PERM_GROUP = new User<>("perm_group", Group.NAME.getType().notUnique().nullable());
    public static final User<String> SERVER = new User<>("server", Server.NAME.getType().notUnique().nullable());
    public static final User<String> SERVER_LAST = new User<>("server_last", Server.NAME.getType().notUnique().nullable());
    public static final User<String> SERVER_LOBBY = new User<>("server_lobby", Server.NAME.getType().notUnique().nullable());
    public static final User<Integer> KIT = new User<>("kit", Game.KIT_ID.getType().notUnique().nullable());
    ...
    public static final User<String> MAIL_MESSAGE = new User<>("message", ColumnType.VARCHAR(255));

    public static final User<String> DISPLAY_GROUP = new User<>("display_group", Group.NAME.getType().notUnique().notNullable());
  ...
  public static class Permission<T> extends Column<T> {
    ...
    public static final Permission<Integer> ID = new Permission<>("id", ColumnType.INTEGER(true));
  ...
  public static class Support<T> extends Column<T> {
    ...
    public static final Support<String> MESSAGE = new Support<>("message", ColumnType.VARCHAR(255));
    public static final Support<Status.Ticket> STATUS = new Support<>("status", ColumnType.STATUS());
    public static final Support<String> ANSWER = new Support<>("answer", ColumnType.VARCHAR(255));
    public static final Support<LocalDateTime> DATE = new Support<>("date", ColumnType.LOCAL_DATE_TIME);
  ...
  public static class Group<T> extends Column<T> {
    ...
    public static final Group<String> INHERITANCE = new Group<>("inheritance", Group.NAME.getType().notUnique().nullable());

    public static final Group<Boolean> SHOW_ALWAYS = new Group<>("show_always", ColumnType.BOOLEAN);
  ...
  public static class Game<T> extends Column<T> {
    ...
    public static final Game<String> DISPLAY_NAME = new Game<>("display_name", ColumnType.VARCHAR(32));
    public static final Game<ExTextColor> TEXT_COLOR = new Game<>("text_color", ColumnType.TEXT_COLOR);
    public static final Game<String> HEAD_LINE = new Game<>("head_line", ColumnType.VARCHAR(255));
    ...
    public static final Game<Integer> LOUNGE_MAP_DISPLAY_Y = new Game<>("display_y", ColumnType.INTEGER);
    public static final Game<Integer> LOUNGE_MAP_DISPLAY_Z = new Game<>("display_z", ColumnType.INTEGER);
    public static final Game<BlockSide> LOUNGE_MAP_DISPLAY_FACING = new Game<>("display_facing", ColumnType.BLOCK_SIDE);
    public static final Game<BlockSide> LOUNGE_MAP_DISPLAY_ORIENTATION = new Game<>("display_orientation", ColumnType.BLOCK_SIDE);
    public static final Game<Color> LOUNGE_MAP_DISPLAY_TITLE_COLOR = new Game<>("display_title_color", ColumnType.COLOR);
    public static final Game<Color> LOUNGE_MAP_DISPLAY_STAT_NAME_COLOR = new Game<>("display_stat_name_color", ColumnType.COLOR);
    public static final Game<Color> LOUNGE_MAP_DISPLAY_STAT_FIRST_COLOR = new Game<>("display_stat_first_color", ColumnType.COLOR);
    public static final Game<Color> LOUNGE_MAP_DISPLAY_STAT_SECOND_COLOR = new Game<>("display_stat_second_color", ColumnType.COLOR);
    public static final Game<Color> LOUNGE_MAP_DISPLAY_STAT_THIRD_COLOR = new Game<>("display_stat_third_color", ColumnType.COLOR);


    // statistics
    public static final Game<String> STAT_TYPE_NAME = new Game<>("name", ColumnType.VARCHAR(255));
    public static final Game<String> STAT_TYPE_DISPLAY_NAME = new Game<>("display_name", ColumnType.VARCHAR(255));
    public static final Game<String> STAT_TYPE_TYPE = new Game<>("type", ColumnType.VARCHAR(255));
    public static final Game<String> STAT_TYPE_DEFAULT_VALUE = new Game<>("default_value", ColumnType.VARCHAR(255));
    public static final Game<Integer> STAT_TYPE_DISPLAY_INDEX = new Game<>("display_index", ColumnType.INTEGER);
    public static final Game<Integer> STAT_TYPE_DISPLAY_LINE_INDEX = new Game<>("display_line_index", ColumnType.INTEGER);
    public static final Game<Boolean> STAT_TYPE_GLOBAL_DISPLAY = new Game<>("global_display", ColumnType.BOOLEAN);
  ...
  public static class Decoration<T> extends Column<T> {
    ...
    public static final Decoration<String> HEAD_NAME = new Decoration<>("name", ColumnType.VARCHAR(32));
    public static final Decoration<String> HEAD_SECTION = new Decoration<>("section", ColumnType.VARCHAR(32));
    public static final Decoration<String> HEAD_TAG = new Decoration<>("tag", ColumnType.VARCHAR(500));
  ...
  public static class Story<T> extends Column<T> {
    ...
    public static final Story<String> BOOK_ID = new Story<>("book_id", ColumnType.VARCHAR(255));
    public static final Story<String> CHAPTER_NAME = new Story<>("chapter_name", ColumnType.VARCHAR(100));
    public static final Story<String> QUEST_NAME = new Story<>("quest_name", ColumnType.VARCHAR(100));
  ...
  public static class Network<T> extends Column<T> {
    ...
    public static final Network<String> FILE_NAME = new Network<>("name", ColumnType.VARCHAR(100));
    public static final Network<File> FILE_PATH = new Network<>("file_path", ColumnType.FILE);
    public static final Network<String> VARIABLE_KEY = new Network<>("key", ColumnType.VARCHAR(100));
    public static final Network<String> VARIABLE_VALUE = new Network<>("value", ColumnType.VARCHAR(100));
