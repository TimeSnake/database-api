...
public class Column<Value> {
    ...
    public static class Server<T> extends Column<T> {
        ...
        public static final Server<Integer> MAX_PLAYERS = new Server<>("max_players", Integer.class,
                ColumnType.integer(6));
        ...
        public static final Server<Integer> TEAM_AMOUNT = new Server<>("team_amount", Integer.class,
                ColumnType.integer(3));
        public static final Server<Integer> TEAM_MAX_PLAYERS = new Server<>("team_max_players", Integer.class,
                ColumnType.integer(3));
        public static final Server<Boolean> TEAM_MERGING = new Server<>("team_merging", Boolean.class,
    ...
    public static class User<T> extends Column<T> {
        ...
        public static final User<String> PUNISH_CASTIGATOR = new User<>("castigator", Server.NAME.getValueClass(),
                User.NAME.getType());
        ...
        public static final User<String> DATA_PROTECTION = new User<>("data_protection", String.class,
    ...
    public static class Permission<T> extends Column<T> {
        public static final Permission<Integer> ID = new Permission<>("id", Integer.class, ColumnType.integer(255,
                true));
        public static final Permission<String> NAME = new Permission<>("name", String.class, ColumnType.varchar(50));
        public static final Permission<String> PERMISSION = new Permission<>("permission", String.class,
                ColumnType.varchar(255));
        public static final Permission<Status.Permission> MODE = new Permission<>("mode", Status.Permission.class,
                ColumnType.varchar(20));
        public static final Permission<DbStringArrayList> SERVER = new Permission<>("server", DbStringArrayList.class
                , ColumnType.varchar(255));
    ...
    public static class Game<T> extends Column<T> {
        ...
        public static final Game<String> MAP_DISPLAY_NAME = new Game<>("display_name", String.class,
                ColumnType.varchar(100));
        ...
        public static final Game<Integer> MAP_MIN_PLAYERS = new Game<>("min_players",
                Server.MAX_PLAYERS.getValueClass(), Server.MAX_PLAYERS.getType());
        public static final Game<Integer> MAP_MAX_PLAYERS = new Game<>("max_players",
                Server.MAX_PLAYERS.getValueClass(), Server.MAX_PLAYERS.getType());
        public static final Game<DbStringArrayList> MAP_DESCRIPTION = new Game<>("description",
                DbStringArrayList.class, ColumnType.varchar(1000));
