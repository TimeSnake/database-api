...
public class DatabaseHungerGames extends DatabaseConnector implements
    de.timesnake.database.util.hungergames.DatabaseHungerGames {

  private final HungerGamesItemsTable itemsTable;

  public DatabaseHungerGames(String name, String url, String options, String user, String password,
